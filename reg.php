            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <button style="padding:1px ;" type="button" class="btn" data-bs-toggle="tooltip"
                                title="Home">
                        ...
                        <div class="card" style="border-radius: 1rem;">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-5 d-none d-md-block">
                                    <img src="https://media.istockphoto.com/id/843394464/photo/hand-hold-a-shopping-basket-full-of-construction-materials.jpg?s=612x612&w=0&k=20&c=e0c-rYzVKn0e7AcOtVNrQNyueGY8UXBwLdsTuUKWf90="
                                        alt="login form" class="img-fluid"
                                        style="border-radius: 1rem 0 0 1rem; padding-top: 10%;" />
                                </div>
                                    ...
                                    <div class="card-body p-4 p-lg-5 text-black">
                                        ...
                                        <form action="reg_db.php" method="post">
                                            ...
                                            <div class="d-flex align-items-center mb-3 pb-1">
                                                ...
                                                <span class="h1 fw-bold mb-0">MaterialSeller</span>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="text" id="form2Example17" name="first_name"
                                                    class="form-control form-control-lg" placeholder="Your First name" title="Enter valid first name"
                                                    required pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter only alphabets.')" />
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="text" id="form2Example17" name="last_name"
                                                    class="form-control form-control-lg" placeholder="Your Last name" title="Enter valid last name"
                                                    required pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter only alphabets.')" />
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="email" id="form2Example17 " name="emailid"
                                                    class="form-control form-control-lg" placeholder="Email address" title="Enter valid email id"
                                                    required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  />
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input type="tel" id="phone" name="phone" title="Enter valid mobile number"
                                                    class="form-control form-control-lg" placeholder="Mobile number"  pattern="[789][0-9]{9}" oninvalid="setCustomValidity('Please enter valid mobile number.')"
                                                    required />
                                            </div>

                                            <div class="form-outline mb-4">
                                                <input type="password" id="form2Example27" name="pass" title="Password should be minimum of 8 characters and contain alphabets , numbers and special symbols"
                                                    class="form-control form-control-lg" placeholder="Password" minlength="8" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,25}$"
                                                    required />
                                            </div>
                                            <div class="form-check">
  <input class="form-check-input" type="checkbox" value="yes" id="flexCheckDefault" name="admin">
  <label class="form-check-label" for="flexCheckDefault">
I want to create this account as admin.  </label>
</div>
                                            <hr>
                                            <?php
                                             if($_SESSION['first_name'])
                                             {
                                                ?>
                                           <div class="pt-1 mb-4" >
                                                <button class="btn btn-dark btn-lg btn-block" type="submit" disabled>Logout first from this account to register another account.
                                                    </button>
                                            </div>
                                            <?php 
                                            }
                                            else
                                            {
                                                ?>
                                                 <div class="pt-1 mb-4">
                                                <button class="btn btn-dark btn-lg btn-block" type="submit">Create
                                                    account</button>
                                            </div>

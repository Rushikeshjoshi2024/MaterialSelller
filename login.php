...
<?php
  ...
  <div class="container-fluid">
    ...
    <nav class="navbar navbar-expand-lg " style="margin-top: 1%; padding: 1px;  border-radius: 2px;">
      ...
      ?>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="2.5rem" height="2.5rem" fill="black" class="bi bi-list"
          viewBox="0 0 16 16">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel"
    style="margin-top: 5rem;margin-bottom: 5rem;margin-right:2rem ; border-radius: 4px;">
...
<p>Terms & Conditions</p></a> 
                         ...
                         <?php } 
                          ...
                          <div class="container text-center">
                            <p>Please login</p>
                <div class="row g-2" style="width:20rem;">
                  <div class="col-6" >
              ...
              <center><div style="padding-top:10rem;">
<a href="termandcondition.html">
<p>Terms & Conditions</p></a>   </center>
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form action="login_db.php" method="post">
                    ...
                    <div class="form-outline mb-4">
                      <input type="email" id="form2Example17" name="email" class="form-control form-control-lg" placeholder="Email address" required/>
                    </div>
                    ...
                    <?php
                                             if($_SESSION['first_name'])
                                             {
                                                ?>
                                           <div class="pt-1 mb-4" >
                                                <button class="btn btn-dark btn-lg btn-block" type="submit" disabled>Logout first from this account to login into another account.
                                                    </button>
                                            </div>
                                            <?php 
                                            }
                                            ...
                                            <a class="small text-muted" href="f_password.php">Forgot password?</a>
  ...
  <ul class="nav justify-content">
    <li>
      ...
      <!-- <a class="position-absolute top-50 start-100" style="padding-left:10rem;"> -->
      <a style="padding-left: 10rem;">
      </a>

...
<br>
  ...
  <div class="row g-2">
    ...
    <div style="padding-top:25%; padding-left:2%;">
...
<p>Terms & Conditions</p></a>   </center>
  ...
  <center>
    <h2>About Us!</h2>
    <h3 style="text-align: center;">Welcome To <span id="W_Name1">MaterialSeller</span></h3>
    <p><span id="W_Name2">MaterialSeller</span> is a Professional <span id="W_Type1">eCommerce </span> Platform. Here we
      will provide you only interesting content, which you will like very much. We're dedicated to providing you the
      best of <span id="W_Type2">eCommerce </span>, with a focus on dependability and <span id="W_Spec">remaining
        construction material</span>. We're working to turn our passion for <span id="W_Type3">eCommerce </span> into a
      booming <a href="https://www.blogearns.com/2021/05/free-about-us-page-generator.html" rel="do-follow"

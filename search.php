...
if(!$conn) {  
    die("Failed to connect with MySQL: ". mysqli_connect_error());  
          ...
          $sql="SELECT * FROM `product_info` WHERE `Material_id`='$_POST[srch]' OR `Material name`='$_POST[srch]' OR `Material category`='$_POST[srch]' OR `City`='$_POST[srch]'";
        ...
        <div class="row g-1">
          ...
          <div class="col-md-8">
            <div class="card-body">
              ...
              <center>
              <?php
                    echo "<a href='perticular_product.php?id=$mat_id' type='button' class='btn btn-outline-primary'>View </a>";
                    ?>              </center>
            </div>
          </div>
        </div>

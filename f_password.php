            ...
            <div class="row g-0">
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form action="f_password_db.php" method="post">
                    ...
                    <div class="form-outline mb-4">
                      <input type="password" id="form2Example27" name="oldpassword"  class="form-control form-control-lg" placeholder="Old Password" required/>
                    </div>
                    <div class="form-outline mb-4">
                      <input type="password" id="form2Example27" name="newpassword" class="form-control form-control-lg" placeholder="New Password" required/>
                    </div>
                    <div class="form-outline mb-4">
                      <input type="password" id="form2Example27" class="form-control form-control-lg" placeholder="Conform New Password" required/>
                    </div>
                    <hr>
                    <div class="pt-1 mb-4">
                    ...
                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Remembered password! <a href="login.php"

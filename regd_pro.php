...
<input type='number' name='count' style='width: 100px;' value='$num'/>
<input type='submit'  class='btn btn-outline-success' value='save'/>
  ...
  <?php
                ...
                echo "<a href='delete_pro.php?id=$mid' type='button' class='btn btn-outline-danger'>delete </a> ";
                echo "<a href='update_pro.php?id=$mid&num=$num' type='submit' class='btn btn-outline-success'>update </a>";
                ?>
              </center>
            </div>
          </div>
